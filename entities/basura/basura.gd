...
var texturas_organicas = [
	preload("res://entities/basura/sprites/trash_apple.png"),
	preload("res://entities/basura/sprites/trash_bone.png"),
	preload("res://entities/basura/sprites/trash_bread.png"),
	preload("res://entities/basura/sprites/trash_chese.png"),
	preload("res://entities/basura/sprites/trash_leaf.png")
]

var texturas_inorganicas = [
	preload("res://entities/basura/sprites/trash_bottle.png"),
	preload("res://entities/basura/sprites/trash_box.png"),
	preload("res://entities/basura/sprites/trash_cup.png"),
	preload("res://entities/basura/sprites/trash_plastic.png"),
	preload("res://entities/basura/sprites/trash_nail.png")
]
func _ready():
	tipo_basura = randi() % 3
