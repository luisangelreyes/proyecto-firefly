...
# ── OBJETOS ───────────────────────────────────────────────────────────────
# TELA:      3 cols x 4 filas → frames 0-11  (512x512, celda 128x128)
# MADERA:    3 cols x 4 filas → frames 0-11  (512x512, celda 128x128)
# INORGANICO:3 cols x 4 filas → frames 0-11  (1024x1536, celda 341x384)
...
const ItemScene = preload("res://entities/basura/ItemMorral_N23.tscn")
...
var fallos               : int  = 0
var desglose : Dictionary = {"tela":0, "madera":0, "inorganico":0}
...
func _get_bote_en(pos: Vector2):
	for bote in [bote_tela, bote_madera, bote_inorganico]:
