...
var texturas_organicas = [
	preload("res://entidades/sprites/basura/organica/trash_apple.png")
	,preload("res://entidades/sprites/basura/organica/trash_bone.png")
	,preload("res://entidades/sprites/basura/organica/trash_bread.png")
	,preload("res://entidades/sprites/basura/organica/trash_chese.png")
	,preload("res://entidades/sprites/basura/organica/trash_leaf.png")
]

var texturas_inorganicas = [
	preload("res://entidades/sprites/basura/inorganica/trash_bottle.png")
	,preload("res://entidades/sprites/basura/inorganica/trash_box.png")
	,preload("res://entidades/sprites/basura/inorganica/trash_cup.png")
	,preload("res://entidades/sprites/basura/inorganica/trash_nail.png")
	,preload("res://entidades/sprites/basura/inorganica/trash_plastic.png")
]
func _ready():
	tipo_basura = randi() % 3
