...
var lista_canciones = [
	preload("res://activos/audio/music/musica_1.ogg") # Asegúrate de que estos nombres coincidan con los tuyos
	,preload("res://activos/audio/music/musica_2.ogg")
	,preload("res://activos/audio/music/musica_3.ogg")
	,preload("res://activos/audio/music/musica_4.ogg")
	,preload("res://activos/audio/music/musica_5.ogg")
	,preload("res://activos/audio/music/musica_6.ogg")
	,preload("res://activos/audio/music/musica_C.ogg")
]

var escena_basura = preload("res://escenas/objetos/basura.tscn")
...
func _on_pausa_pressed():
	# En lugar de buscar el menú, emitimos un grito global
	SesionGlobal.abrir_menu_pausa.emit()
